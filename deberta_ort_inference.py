...
def correctness_check_engines():
    ...
    for precision in CORRECTNESS:
        ...
        engine_cachepath1 = '/'.join([ENGINE_PATH, '_'.join([MODEL_STEM+'_original', gpu_name, precision, 'ort'])])
        engine_cachepath2 = '/'.join([ENGINE_PATH, '_'.join([MODEL_STEM+'_plugin', gpu_name, precision, 'ort'])])
